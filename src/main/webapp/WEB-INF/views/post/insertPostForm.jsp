...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<form id="form1" method="post" action="${cp }/post/insertPost" enctype="multipart/form-data">
				<input type="hidden" id="sum_parent" name="post_parent" value="0">
				<input type="hidden" id="userid"     name="userid"      value="${S_MEMBER.userid }">
